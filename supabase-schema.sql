...
create policy "Allow public delete resident_responses"
  on resident_responses for delete using (true);

-- If you already have the tables, run these to add new features:
